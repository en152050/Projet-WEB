...
<div class="container-fluid" style="padding-top: 80px;">
    <h1> Changer de photo de profil </h1>
    ...
    <div class="col-lg-9" style="height:1500px; "> 
      ...
      <form action="changer_photo2.php" method="post"> 
        <table>
          <tr>
            <td> <input type="text" name="cheminphoto" placeholder="Chemin de la photo" style= "margin:10px; width:300px; height:30px;" required> </td> 
          </tr>
